...
#
# SINGLE SoT for HISTORY_LEN (env.game_state imports this; there is no second independent
# definition). Its LOAD-BEARING COUPLING to the 18-plane source layout — HISTORY_LEN was also
# the opponent block's source-plane offset — went with the dense encode kernels (R346(f)).
# What it bounds now is the `GameState.move_history` deque depth and nothing else.
HISTORY_LEN: int = 8
