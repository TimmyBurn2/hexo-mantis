...
Distinct from ``corpus_metrics`` (the distribution-analysis ``analyse_*`` module);
this holds the pipeline-side counters (renamed to disambiguate).
"""
...
class CorpusMetrics:
    """Accumulates per-source counters and flushes them via the logger.
