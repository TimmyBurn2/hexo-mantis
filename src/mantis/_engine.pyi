...
class Board:
    ...
    def override_legal_move_radius(self, radius: int) -> None: ...
...
# --------------------------------------------------------------------------- #
class ReplayBuffer:
    def __init__(self, capacity: int, encoding: str = "v6") -> None: ...
...
# --------------------------------------------------------------------------- #
class HexgBuffer:
    def __init__(self, capacity: int, encoding: str = "gnn_axis_v1") -> None: ...
