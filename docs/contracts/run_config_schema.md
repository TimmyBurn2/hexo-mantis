...
- status: LIVE since scaffold (WP0). Thirteen growth steps since (v1 -> v14). Each through v6 is
...
Eleven top-level fields; **188 leaf key-paths** under the walker that descends nested blocks
