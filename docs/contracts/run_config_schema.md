...
- status: LIVE since scaffold (WP0). Fourteen growth steps since (v1 -> v15). Each through v6 is
...
Eleven top-level fields; **191 leaf key-paths** under the walker that descends nested blocks
