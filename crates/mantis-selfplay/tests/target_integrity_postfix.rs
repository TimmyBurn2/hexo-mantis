...
/// Test slot geometry passed explicitly below (post-R255 the production value is
/// DERIVED from the sims regime at composition; 128 keeps these frozen oracles'
/// boundary arithmetic unchanged).
