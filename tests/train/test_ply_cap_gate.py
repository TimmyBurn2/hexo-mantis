# >300 justify (R8). One halt, one witness: the planted break proves something only beside the
# fire it mirrors, on the same harness, so the producer test and its mutation stay in one file.
...
class _Pool:
    """Its ply-cap window is a SCRIPT over the games completed: `flags[i]` is game i's cap flag."""
