...
# decides the other" — asserted from SIX angles over ONE set of fakes and ONE builder-derived
# config factory. The six pins are only evidence BECAUSE they share that factory: each states
...
CAPABILITY to state them apart, and these six pins are what make the split real rather than
