# >300 justify (R8): the G-01..G-15 old-suite port (vectors and assertions frozen to hexo_rl's test_instrumentation.py) + the G-17 DV-10 scipy pin all bind ONE module, selfplay/instrumentation.py, through one shared _game_complete driver; a split would scatter a single frozen suite's numbering across files.
