...
def test_the_round_spec_carries_the_batching_across_the_process_seam() -> None:
    ...
    spec = RoundSpec(
        ...
        inference_batching=batching, leaf_batch_size=8, c_visit=50.0, c_scale=1.0, q_rescale=True, search_kind="puct", gumbel_m=16, max_plies=128, leaf_build_threads=1, concurrency=1, rung_concurrency=1,
    )
