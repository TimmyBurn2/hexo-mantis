"""`GnnArchV2SoftPolicy` (R366(b)): a sibling kind whose net serves V2's outputs exactly and evaluates its second policy head only on the trainer's entry; the two soft-policy kind tables agree."""
