...
REQUIRED_TEST_VALUES: dict[str, Any] = {
    "gate_interval": 1, "alert_entropy_min": 1.0, "collapse_threshold_nats": 1.5,
    "alert_grad_norm_max": 10.0, "alert_loss_increase_window": 3, "axis_warn": 0.45,
    "axis_alert": 0.50, "actor_lag_threshold_steps": 100, "actor_lag_abort_enabled": False,
